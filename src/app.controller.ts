...
<p>You can request deletion of a Transpo24 Customer or Driver account here without reinstalling the app. Email us from the address associated with your account and include the phone number used to sign in and whether it is a customer or driver account.</p>
<p><a class="button" href="mailto:info@transpo24.com?subject=Transpo24%20account%20deletion%20request">Email an account deletion request</a></p>
<p>If you still have the app, you can also delete the account directly:</p>
